...
private fun PermissionDialog(
    ...
    val title = when (prompt) {
        PermissionPrompt.ACCESSIBILITY,
        PermissionPrompt.START_ACCESSIBILITY -> "Allow controlled taps"

        PermissionPrompt.OVERLAY,
        PermissionPrompt.START_OVERLAY -> "Allow floating controls"
    }
    val body = when (prompt) {
        PermissionPrompt.ACCESSIBILITY,
        PermissionPrompt.START_ACCESSIBILITY ->
            "Turn on Aalam in Android Accessibility settings. Android requires you to approve this access manually."

        PermissionPrompt.OVERLAY,
        PermissionPrompt.START_OVERLAY ->
            "Allow Aalam to display its small vertical control panel above other apps."
    }
    AlertDialog(
        ...
        confirmButton = {
            TextButton(onClick = onConfirm) {
                Text(if (isStartFlow) "OPEN SETTINGS" else "CONTINUE")
            }
        },
        dismissButton = {
