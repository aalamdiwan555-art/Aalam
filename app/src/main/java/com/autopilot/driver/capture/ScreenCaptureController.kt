...
class ScreenCaptureController(
    ...
    private val onFrame: (Bitmap, CaptureGeometry) -> Unit,
    ...
    fun start(projection: MediaProjection) {
        ...
        val display = (context.getSystemService(Context.DISPLAY_SERVICE) as DisplayManager)
            ...
            ?: throw IllegalStateException("The default display is unavailable")
...
/**
 * Geometry captured with each frame. OCR bounds and gesture coordinates are only
 * valid for this display/rotation/size combination.
 */
